...
class TmaDescKernelParam:
    ...
    def __init__(self, ptr, dims, block_dims, element_size):
        ...
        if len(dims) == 1:
            ...
            triton.runtime.driver.active.utils.fill_3d_tma_descriptor(
                ptr,
                dims[0],
                dims[1],
                dims[2],
    ...
    # Return a MUtensorDescriptor* pointer in host memory
...
def create_3d_tma_descriptor(ptr, dim2, dim1, dim0, block_dim2, block_dim1, block_dim0, element_size):
    return TmaDescKernelParam(ptr, [dim2, dim1, dim0], [block_dim2, block_dim1, block_dim0], element_size)
