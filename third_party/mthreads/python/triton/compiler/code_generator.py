...
from ..language.core import _unwrap_if_constexpr, mt_tma_desc_type, _value
    ...
    def visit_FunctionDef(self, node):
        ...
        for i in range(len(arg_names)):
            if i in self.constants:
                ...
                if isinstance(self.prototype.param_types[idx], mt_tma_desc_type):
                    self.fn.set_arg_attr(idx, "tt.mt_tma_desc", 1)
