...
def matmul_kernel_tma(
    ...
    c0 = c0.to(tl.float16)
    c1 = c1.to(tl.float16)
    tl._experimental_descriptor_store(c_desc_ptr, c0, [offs_am, offs_bn0])
    tl._experimental_descriptor_store(c_desc_ptr, c1, [offs_am, offs_bn1])
...
@pytest.mark.parametrize("BLOCK_M, BLOCK_N, BLOCK_K", [(32, 64, 32)])
